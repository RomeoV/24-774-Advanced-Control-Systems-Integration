...
#ifndef RTW_HEADER_System_inverted_h_
#define RTW_HEADER_System_inverted_h_
#include <math.h>
#include <string.h>
#ifndef System_inverted_COMMON_INCLUDES_
# define System_inverted_COMMON_INCLUDES_
#include "rtwtypes.h"
...
#endif                                 /* System_inverted_COMMON_INCLUDES_ */

#include "System_inverted_types.h"
...
#define System_inverted_rtModel        RT_MODEL_System_inverted_T

/* Block signals (default storage) */
typedef struct {
  real_T HILReadEncoderTimebase_o1;    /* '<S6>/HIL Read Encoder Timebase' */
  real_T HILReadEncoderTimebase_o2;    /* '<S6>/HIL Read Encoder Timebase' */
  real_T Pendulumcountstorad;          /* '<S13>/Pendulum:  counts to rad' */
  real_T Armcountstorad;               /* '<S13>/Arm: counts to rad' */
  real_T WhiteNoise;                   /* '<S2>/White Noise' */
  real_T Output;                       /* '<S2>/Output' */
  real_T Gain3;                        /* '<Root>/Gain3' */
  real_T Sum3;                         /* '<Root>/Sum3' */
  real_T Internal;                     /* '<S4>/Internal' */
  real_T Internal_h;                   /* '<S5>/Internal' */
...
typedef struct {
  real_T HILInitialize_FilterFrequency[2];/* '<S6>/HIL Initialize' */
  ...
  int32_T HILInitialize_ClockModes;    /* '<S6>/HIL Initialize' */
  int32_T HILInitialize_DOStates;      /* '<S6>/HIL Initialize' */
  int32_T HILInitialize_QuadratureModes[2];/* '<S6>/HIL Initialize' */
  int32_T HILInitialize_InitialEICounts[2];/* '<S6>/HIL Initialize' */
  int32_T HILReadEncoderTimebase_Buffer[2];/* '<S6>/HIL Read Encoder Timebase' */
  uint32_T RandSeed;                   /* '<S2>/White Noise' */
} DW_System_inverted_T;

/* Continuous states (default storage) */
typedef struct {
  real_T Internal_CSTATE;              /* '<S4>/Internal' */
  real_T Internal_CSTATE_m;            /* '<S5>/Internal' */
} X_System_inverted_T;
...
typedef struct {
  real_T Internal_CSTATE;              /* '<S4>/Internal' */
  real_T Internal_CSTATE_m;            /* '<S5>/Internal' */
} XDot_System_inverted_T;

/* State disabled  */
typedef struct {
  boolean_T Internal_CSTATE;           /* '<S4>/Internal' */
  boolean_T Internal_CSTATE_m;         /* '<S5>/Internal' */
} XDis_System_inverted_T;
...
#define rtB                            System_inverted_B
#define BlockIO                        B_System_inverted_T
#define rtX                            System_inverted_X
#define ContinuousStates               X_System_inverted_T
#define rtXdot                         System_inverted_XDot
#define StateDerivatives               XDot_System_inverted_T
#define tXdis                          System_inverted_XDis
#define StateDisabled                  XDis_System_inverted_T
#define rtP                            System_inverted_P
#define Parameters                     P_System_inverted_T
#define rtDWork                        System_inverted_DW
#define D_Work                         DW_System_inverted_T

/* Parameters (default storage) */
struct P_System_inverted_T_ {
  real_T gain;                         /* Variable: gain
                                        * Referenced by: '<Root>/Gain3'
                                        */
  real_T lqr_k[4];                     /* Variable: lqr_k
  ...
  real_T Internal_A_f;                 /* Computed Parameter: Internal_A_f
                                        ...
                                        */
  real_T Internal_B_o;                 /* Computed Parameter: Internal_B_o
                                        * Referenced by: '<S5>/Internal'
                                        */
  ...
  real_T Internal_D_b;                 /* Computed Parameter: Internal_D_b
                                        * Referenced by: '<S5>/Internal'
                                        */
  real_T Internal_InitialCondition_b;  /* Expression: 0.0
                                        * Referenced by: '<S5>/Internal'
                                        */
...
struct tag_RTM_System_inverted_T {
  const char_T *path;
...
extern P_System_inverted_T System_inverted_P;

/* Block signals (default storage) */
extern B_System_inverted_T System_inverted_B;

/* Continuous states (default storage) */
extern X_System_inverted_T System_inverted_X;

/* Block states (default storage) */
extern DW_System_inverted_T System_inverted_DW;

/* Model entry point functions */
extern void System_inverted_initialize(void);
extern void System_inverted_output(void);
extern void System_inverted_update(void);
extern void System_inverted_terminate(void);

/*====================*
 * External functions *
 *====================*/
extern System_inverted_rtModel *System_inverted(void);
...
extern RT_MODEL_System_inverted_T *const System_inverted_M;

/*-
 * These blocks were eliminated from the model due to optimizations:
 *
 * Block '<S1>/Output' : Unused code path elimination
 * Block '<S1>/White Noise' : Unused code path elimination
 ...
 *
 * '<Root>' : 'System_inverted'
 * '<S1>'   : 'System_inverted/Band-Limited White Noise'
 * '<S2>'   : 'System_inverted/Band-Limited White Noise1'
 * '<S3>'   : 'System_inverted/Chirp Signal2'
 * '<S4>'   : 'System_inverted/LTI System1'
 * '<S5>'   : 'System_inverted/LTI System2'
 * '<S6>'   : 'System_inverted/Plant'
 * '<S7>'   : 'System_inverted/LTI System1/IO Delay'
 * '<S8>'   : 'System_inverted/LTI System1/Input Delay'
 * '<S9>'   : 'System_inverted/LTI System1/Output Delay'
 * '<S10>'  : 'System_inverted/LTI System2/IO Delay'
 * '<S11>'  : 'System_inverted/LTI System2/Input Delay'
 * '<S12>'  : 'System_inverted/LTI System2/Output Delay'
 * '<S13>'  : 'System_inverted/Plant/Counts to Angles'
 */
#endif                                 /* RTW_HEADER_System_inverted_h_ */
